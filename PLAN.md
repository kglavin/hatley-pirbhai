...
| `examples/fishing-rig/` | Second dogfood project — automated fishing rig (tension sensor → state-machine → reel actuator). Stage 1 (level-0 Context) locked; level-1 DFD + CSPEC future. Tests transferability of toolkit + workflow outside solar. | Active — Stage 1 locked |
